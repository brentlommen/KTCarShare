...
urlpatterns  ={
    ...
    url(r'^comment/(?P<res_num>[0-9]+)/$', views.comments, name='comments'),
    ...
    url(r'^maintenanceCheck/$', views.maintenanceCheck, name='maintenanceCheck'),
    url(r'^searchByLocation/(?P<car_num>[0-9]+)/reservations/$', views.carReservations, name='carReservations')
}